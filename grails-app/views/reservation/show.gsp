            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="reservation.dateCreated.label" default="Date Created" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${reservationInstance?.dateCreated}" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:formatDate date="${reservationInstance?.fechaHoraReservacion}" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:formatDate date="${reservationInstance?.fechaHoraTerminoDeUso}" /></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="reservation.lastUpdated.label" default="Last Updated" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${reservationInstance?.lastUpdated}" /></td>
